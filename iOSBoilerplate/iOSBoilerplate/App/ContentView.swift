...
struct AppStrings {
    //MARK: - AuthorizationScreen
    static let LoginScreenTitle: LocalizedStringKey = "Login/SignUp"
    ...
    static let TermsAndConditions: LocalizedStringKey = "Terms&Conditions"
    static let DummyTermsAndConditions: LocalizedStringKey = "DummyTermsAndConditions"
    static let ReadAndAcceptTermsConditions: LocalizedStringKey = "ReadAndAcceptTerms&Conditions"
    ...
    static let TemperatureIs: LocalizedStringKey = "TemperatureIs"
    static let RealFeelIs: LocalizedStringKey = "RealFeelIs"
    static let MaxItWillGoIs: LocalizedStringKey = "MaxItWillGoIs"
    static let MinItWillFallIs: LocalizedStringKey = "MinItWillFallIs"
    static let YouCanSeeAsFarAs: LocalizedStringKey = "YouCanSeeAsFarAs"
    static let ThePressureYouBeFeelingIs: LocalizedStringKey = "ThePressureYouBeFeelingIs"

    //MARK: - Cities
    static let Delhi: LocalizedStringKey = "Delhi"
    static let Jaipur: LocalizedStringKey = "Jaipur"
    static let Mumbai: LocalizedStringKey = "Mumbai"
    static let Chennai: LocalizedStringKey = "Chennai"
    static let Bengaluru: LocalizedStringKey = "Bengaluru"
    static let Kolkata: LocalizedStringKey = "Kolkata"
